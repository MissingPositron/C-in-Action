...
namespace MyPhotos
{
    public partial class MainForm : Form
    {
        ...
        private void SetTitleBar()
        {
            ...
            this.Text = String.Format("{2} - {0:0}.{1:0}", ver.Major, ver.Minor,
        ...
        private void menuFileSave_Click(object sender, EventArgs e)
        {
            ...
            if (AlbumController.SaveAlbumDialog(ref path))
            {
                ...
                // Update the title bar to include new name
                SetTitleBar();
            }
        }

        protected void menuFileSaveAs_Click(object sender, EventArgs e)
        {
            SaveAsAlbum();
        }
